...
public abstract class AbstractArenaUIPortletConfigurationAction<C> extends DefaultConfigurationAction {
    ...
    public static final Log LOGGER = LogFactoryUtil.getLog(AbstractArenaUIPortletConfigurationAction.class);
