...
public class ArenaUIPortletKeys {
    ...
    public static final String GITHUB_PORTLET_NAME = "com_axiell_arena_ui_poc_github";
    ...
    public static final String HEROES_PORTLET_NAME = "com_axiell_arena_ui_poc_heroes";
    ...
    public static final String HEROES_PORTLET_CONFIG_TEMPLATE = "/configuration-heroes.jsp";
    public static final String TODO_PORTLET_NAME = "com_axiell_arena_ui_poc_todo";
