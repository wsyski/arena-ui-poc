...
public class ArenaUIPortletKeys {
    ...
    public static final String CALENDAR_PORTLET_NAME = "calendar";
    public static final String CALENDAR_PORTLET_DISPLAY_NAME = "Calendar Portlet";
    public static final String CALENDAR_PORTLET_CONFIGURATION = "com.axiell.arena_ui_poc.calendar.CalendarPortletConfiguration";
    public static final String CALENDAR_PORTLET_CONFIG_TEMPLATE = "/configuration-"+CALENDAR_PORTLET_NAME+".jsp";
    ...
    public static final String TODO_PORTLET_CONFIG_TEMPLATE = "/configuration-"+TODO_PORTLET_NAME+".jsp";
}