...
<%@page	import="com.axiell.arena_ui_poc.heroes.HeroesPortletConfiguration" %>

<%
	HeroesPortletConfiguration portletConfiguration =
			(HeroesPortletConfiguration)renderRequest.getAttribute(HeroesPortletConfiguration.class.getName());
