...
var app_github_routes_1 = require("./app-github.routes");
    ...
    AppGithubModule = __decorate([
        core_1.NgModule({
            ...
            imports: [
                ...
                http_1.HttpModule,
                router_1.RouterModule.forRoot(app_github_routes_1.rootRouterConfig, { useHash: true })
            ],
            providers: [
                github_service_1.GithubService
            ],
            bootstrap: [app_github_component_1.AppGithubComponent]
        })
    ], AppGithubModule);
    return AppGithubModule;
}());
exports.AppGithubModule = AppGithubModule;
